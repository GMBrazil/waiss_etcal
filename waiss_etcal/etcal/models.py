...
class Farm(models.Model):
    ...
    farm_lat_dir = models.CharField(max_length=5, verbose_name="Latidute Direction", null=True)
    farm_long = models.DecimalField(max_digits=10, decimal_places=7, verbose_name="Longitude (°)", null=True, blank=True)
    farm_long_dir = models.CharField(max_length=5, verbose_name="Longitude Direction", null=True)
...
class Station(models.Model):
    ...
    station_lat_dir = models.CharField(max_length=5, verbose_name="Latidute Direction", null=True)
    station_long = models.DecimalField(max_digits=10, decimal_places=7, verbose_name="Longitude (°)", null=True)
    station_long_dir = models.CharField(max_length=5, verbose_name="Longitude Direction", null=True)
