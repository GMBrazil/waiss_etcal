...
//get all farm names
var farms = [{% for farm in farm_info %}{% if forloop.last %}{{ farm.farm_name }}{% else %}{{ farm.farm_name }}, {% endif %}{% endfor %}];
//get all station names
var stations = [{% for sta in station_info %}{% if forloop.last %}{{ sta.station_name }}{% else %}{{ sta.station_name }}, {% endif %}{% endfor %}];
